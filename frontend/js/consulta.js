(() => {
  ...
  const groupFor=c=>c.table==='intervenciones'?'Operaciones':['desaparecidos','detenidos','rq','prostitucion','victimas','menores','migraciones','personas_ubicadas','expulsados'].includes(c.id)?'Personas':c.table==='intervencion_grupos'?'Grupos criminales':c.table==='intervencion_drogas'?'Drogas':'Bienes y otros resultados';
