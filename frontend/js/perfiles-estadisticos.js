...
window.PERFILES_ESTADISTICOS = {"estadistico_direccion": "Estadístico de Dirección", "estadistico_division": "Estadístico de División", "estadistico_jefatura": "Estadístico de Jefatura · JEFDDITP", "estadistico_depitptim": "Estadístico de DEPITPTIM"};
...
window.puedeRegistrarUnidad = unidad => {
 if (!currentProfile?.activo) return false;
