...
html = html.replace('</body>', `<script>${mock}</script><script src="/perfiles-estadisticos.js"></script>
...
const allowed = new Set(['perfiles-estadisticos.js','dashboard.css','registros.css','complementarios-catalogo.js','complementarios.js','prostitucion.js','prostitucion-catalogo.js','victimas.js','victimas-catalogo.js','notas.js','notas-catalogo.js','requisitoriados-catalogo.js','menores.js','menores-catalogo.js','styles.css','catalogos.js','dependencias.js','catalogos-ui.js','intervenciones.js','detenidos.js','resultados.js','requisitoriados.js','grupos.js','materiales.js','materiales-catalogo.js','vehiculos.js','vehiculos-catalogo.js','assets/logo-diriptim.png']);
http.createServer((req,res)=>{
  ...
  if(name==='format-migration'){res.setHeader('Content-Type','text/html; charset=utf-8');return res.end('<pre>'+fs.readFileSync(path.join(root,'supabase/migrations/202609230018_formato_produccion.sql'),'utf8').replace(/&/g,'&amp;').replace(/</g,'&lt;')+'</pre>');}
